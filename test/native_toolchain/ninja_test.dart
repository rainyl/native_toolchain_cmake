  ...
  group('Ninja selection: ', () {
    ...
    group('Android target: ', () {
      ...
      test('one Android ninja, no system ninja, prefers system ninja', () async {
        ...
        expect(
          () async => ninja.defaultResolver!.resolve(logger: logger, userConfig: userConfig),
    ...
    group('iOS target: ', () {
      ...
      test(
        'one Android ninja, no system ninja, prefer Android ninja, user defined version not found',
        () async {
          when(
            () => mockAndroidResolver.resolve(
              logger: any(named: 'logger'),
      ...
      test(
        'one Android ninja, one system ninja, do not prefer Android ninja, user defined version',
        () async {
          when(
            () => mockAndroidResolver.resolve(
              logger: any(named: 'logger'),
      ...
      test(
        'many Android ninja, one system ninja, prefer Android ninja, user defined dirty version',
        () async {
          when(
            () => mockAndroidResolver.resolve(
              logger: any(named: 'logger'),
